...
static const APP_PARAM_SNS_CFG_T sns_cfg_gc2083 = {
    .s32SnsId     = 0,
    .enSnsType    = SENSOR_GCORE_GC2083,
    .s32Framerate = 30,
    .s32BusId     = 3,
    .s32I2cAddr   = 0x37,
    .MipiDev      = 0,
    .as16LaneId   = {2, 0, 1, -1, -1},
    .as8PNSwap    = {0, 0, 0, 0, 0},
    .bMclkEn      = 1,
    .u8Mclk       = 0,
...
static const APP_PARAM_SNS_CFG_T* supported_sensors[] = {&sns_cfg_gc2083};
...
int app_ipcam_Param_Load(void) {
    for (int i = 0; i < VI_MAX_PIPE_NUM; i++) {
        ...
        g_aeGc2083_MirrorFip[i] = ISP_SNS_NORMAL;
